...
bool DxDevices::init(HWND hWnd)
{
	...
	return init(hWnd, (rc.right - rc.left), (rc.bottom - rc.top));
}
//----------------------------------------------------------------------------

bool DxDevices::init(HWND hWnd, UINT width, UINT height)
{
	//--------------------------------
...
void DxDevices::enableBlend() const
{
	D3D11_BLEND_DESC bd;
	...
	bd.RenderTarget[0].RenderTargetWriteMask = D3D10_COLOR_WRITE_ENABLE_ALL;//0x0f;

	ID3D11BlendState * blendState;
	m_device11->CreateBlendState(&bd, &blendState);
...
void DxDevices::disableBlend() const
{
