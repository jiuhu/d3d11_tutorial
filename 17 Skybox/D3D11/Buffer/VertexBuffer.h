...
public:
	...
	*/
	...
	/*
		This function is called to load vertex buffer data from a float array.
	*/
	bool loadColorVertexBuffer(const float * const vertices, UINT vertexCount, bool hasTexture, D3D11_PRIMITIVE_TOPOLOGY topology = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST); 
