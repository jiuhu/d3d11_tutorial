...
#include <D3D11.h>
#include "D3D11/DxPositioner.h"
#include "D3D11/Font/FontList.h"
...
public:
	...
	static DxPositioner _positioner;

	static FontList _fontList;
	...
	*/
	...
	/*
		This function is called to get the viewport size.
	*/
	void getViewPort(FLOAT &width, FLOAT &height) const;

	/*
		This function is called to get the aspect ratio.
	*/
	...
	*/
	void polygonMode(D3D11_FILL_MODE mode);
	...
	*/
	void toggleDepth(bool depthOn);

	/*
		This function is called to toggle full screen mode.
	*/
...
private:
	...
	//	Pointer to the rasterizer state.
	ID3D11RasterizerState * m_rasterizerState;

	//	Pointer to the depth stencil state.	
...
inline void DxDevices::getViewPort(FLOAT &width, FLOAT &height) const
{
    D3D11_VIEWPORT vp;
	UINT num[] = {1};
...
inline float DxDevices::getAspectRatio() const
{
	float width, height;
...
inline void DxDevices::enableDepth()
{
	toggleDepth(true);
}
//--------------------------------------------------------------------

inline void DxDevices::disableDepth()
{
	toggleDepth(false);
}
//--------------------------------------------------------------------
...
inline void DxDevices::fullScreen(bool fullScreenOn)
{
	m_swapChain->SetFullscreenState(fullScreenOn, NULL);	
}
//--------------------------------------------------------------------